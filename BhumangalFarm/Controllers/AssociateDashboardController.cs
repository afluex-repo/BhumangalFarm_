                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows[0]["Msg"].ToString() == "1")
                    {
                        ...
                        try
                        {
                            ...
                            BLSMS.SendSMS(mob, "Dear "+ name + ", Your Payout Request of Rs"+ payout + " has been processed successfully. Your amount will be credited in your account within 1 to 5 working days. BhumangalFarm", TempId);
